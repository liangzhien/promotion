...
(function($){
    $.fn.j360 = function(options) {
        ...
        return this.each(function() {
            ...
            $overlay.html('<img src="../images/loader.gif"  class="loader" style=" width:55px;margin-top:' + ($obj.height()/2 - 15) + 'px" />');
...
function preload(image) {
    ...
    try {
        ...
        div.innerHTML = "<img class=\"preload_img\" style='width:800px;' src=\"" + image + "\" />";
    } catch(e) {
    // Error. Do nothing.
    }
}